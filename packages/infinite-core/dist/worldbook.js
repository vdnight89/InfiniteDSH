...
export function findMatchingEntries(entries, contextText) {
 ...
 */
export function buildWorldContext(entries, recentText, bookName, options) {
...
export function buildCharacterContext(entries, recentText, protagonist) {
    const enabled = entries.filter((e) => !e.disabled);
