...
这是 DeepSeek Harness 上的文学插件。仓库名 InfiniteDSH，组合包名 `dsh-infinite`。当前 **0.4.3**。  
...
| 想钉死这一刀 | `dsh plugin --profile web add github:vdnight89/InfiniteDSH#v0.4.3` |
...
| `/export-story` | 拟题后誊出书稿到当前工作区（不是上面那个会话日志压缩包）。 |
